<section class="services-section">
    <div class="services-wrapper">
        <div class="services-content">
            ...
            <h3 > Поможем вам обрести густые и красивые <br> волосы</h3>
            <p>
        ...
        <div class="button-container-vertical">
            <input class="custom-button-vertical" type="button" value="Прайс на услуги"
                  onclick="showPrices()" />
            ...
            <input class="custom-button-vertical" type="button" value="Turbo солярий"
                   onclick="TurboPrices()"/>

            <img id="turbo-sol" src="{{ asset('img/price/price_turbo_so.jpg') }}" style="display: none; max-width: 320px;
             " alt="Turbo солярий"/>

            <button class="custom-button-vertical">Обучения</button>
        </div> <hr>
            </div>
        </div>
    </section>
